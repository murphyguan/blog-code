    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="网站信息" name="info">
        ...
        >
          ...
          <el-form-item label="第三方登录">
            <el-checkbox-group v-model="socialLoginList">
      ...
      <el-tab-pane label="社交信息" name="notice">
        <el-form label-width="70px" :model="websiteConfigForm">
          <el-checkbox-group v-model="socialUrlList">
  ...
  methods: {
    getWebsiteConfig() {
      this.axios.get("/api/admin/website/config").then(({ data }) => {
        ...
        this.socialLoginList = this.websiteConfigForm.socialLoginList
        this.socialUrlList = this.websiteConfigForm.socialUrlList
      });
    },
    handleClick(tab) {
      console.log(tab);
    ...
    updateWebsiteConfig() {
      this.websiteConfigForm.socialLoginList = this.socialLoginList
      this.websiteConfigForm.socialUrlList = this.socialUrlList
      this.axios
